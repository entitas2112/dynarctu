...
ID: TKA_001
Type: PilihanGanda
Question: Benua yang memiliki luas wilayah paling besar di dunia adalah...
Answer: Asia
Explanation: >
  Asia adalah benua terbesar di dunia baik dari segi luas wilayah 
  maupun jumlah populasi penduduknya.
Options:
  - Text: Afrika
  - Text: Amerika
  - Text: Eropa
...
Question: Manakah dari daftar berikut yang termasuk ke dalam unsur intrinsik sebuah karya sastra?
Explanation: Unsur intrinsik adalah unsur yang membangun karya sastra dari dalam, seperti tema dan alur.
Options:
  - Text: Tema
    IsCorrect: true
  - Text: Alur
...
ID: TKA_003
Type: BenarSalah
Question: Tentukan Benar atau Salah pada setiap pernyataan berikut terkait fenomena alam!
Explanation: Gerhana matahari terjadi saat bulan berada di antara bumi dan matahari, sedangkan siklus air melibatkan penguapan dan presipitasi.
Options:
  - Text: Gerhana matahari terjadi saat posisi bumi berada di antara matahari dan bulan.
    IsCorrect: Salah
  - Text: Proses perubahan air menjadi uap karena panas matahari disebut evaporasi.
    IsCorrect: Benar
  - Text: Rotasi bumi adalah penyebab utama terjadinya pergantian musim.
    IsCorrect: Salah
---
```
