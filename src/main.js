 ...
 *
 * Application wiring only. Question selection and answer grading both
 * happen server-side in api/quiz/* (Vercel serverless functions) — this
 * file only drives the UI and never sees a correct answer until after it
 * submits the user's guess and the server tells it whether that guess was
 * right.
 */
import './style.css';
